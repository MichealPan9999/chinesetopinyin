package com.example.editablealphalist;
...
import com.example.editablealphalist.adapter.SortAdapter;
import com.example.editablealphalist.bean.SortModel;
import com.example.editablealphalist.utils.CharacterParser;
import com.example.editablealphalist.utils.Pinyin4JUtil;
import com.example.editablealphalist.utils.PinyinComparator;
import com.example.editablealphalist.widgget.ClearEditText;
import com.example.editablealphalist.widgget.SideBar;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pinyin4JUtil = new Pinyin4JUtil(this);
        initViews();
    }
    ...
    private List<SortModel> filledData(String[] data) {
        ...
        for (int i = 0; i < data.length; i++) {
            ...
            //String pinyin = pinyin4JUtil.getPingYin(data[i]);
            String pinyin = pinyin4JUtil.convertChineseToPinyin(data[i]);
            Log.d("panzqww",data[i]+"--- pinyin ："+pinyin);
